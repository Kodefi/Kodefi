...
var app = (function () {
    ...
    function create_fragment$a(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "col s10 m4 l3 l1440 offset-s1 offset-m2 offset-l1440 svelte-1g58yqu");
    			attr(div1, "class", "col s10 m4 l3 l1440 offset-s1 svelte-1g58yqu");
    			attr(div2, "class", "col s10 m4 l3 l1440 offset-m2 offset-s1 svelte-1g58yqu");
    			attr(div3, "class", "col s10 m4 l3 l1440 offset-s1 svelte-1g58yqu");
    			attr(div4, "class", "row svelte-1g58yqu");
    		},
    		m(target, anchor) {
    ...
    class Kodefi extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$3, create_fragment$9, safe_not_equal, { type: 2, style: 0 });
    	}
    }
    ...
    function create_fragment$8(ctx) {
    	...
    	return {
    		c() {
    			...
    			t2 = space();
    			li1 = element("li");
    			li1.innerHTML = `<a href="#compromiso" class="svelte-1fv27n5">Compromiso</a>`;
    			t4 = space();
    			li2 = element("li");
    			li2.innerHTML = `<a href="/" class="svelte-1fv27n5">Blog</a>`;
    			t6 = space();
    			li3 = element("li");
    			li3.innerHTML = `<a target="_blank" href="https://github.com/Kodefi" class="svelte-1fv27n5">Open Source</a>`;
    			t8 = space();
    			li4 = element("li");
    			...
    			attr(li1, "class", "hide-on-med-and-down");
    ...
    class WebDevelopment extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$7, safe_not_equal, { style: 0 });
    	}
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			t16 = space();
    			div11 = element("div");
    			div11.innerHTML = `<input style="color: #fff7f2; background-color: #669fa4" type="submit" value="Enviar" class="col s6 btn offset-s3 svelte-1t7hf0m"/>`;
    			attr(div0, "class", "center");
    			input0.required = true;
    			attr(input0, "id", "name");
    			attr(input0, "type", "text");
    			attr(input0, "class", "validate svelte-1t7hf0m");
    			attr(label0, "for", "name");
    			attr(label0, "class", "svelte-1t7hf0m");
    			attr(div1, "class", "input-field col s12 svelte-1t7hf0m");
    			attr(div2, "class", "row");
    			attr(input1, "type", "checkbox");
    			attr(input1, "class", "svelte-1t7hf0m");
    			attr(label1, "class", "svelte-1t7hf0m");
    			attr(div3, "class", "input-field col s12 svelte-1t7hf0m");
    			attr(div4, "class", "row trap svelte-1t7hf0m");
    			input2.required = true;
    			attr(input2, "id", "email");
    			attr(input2, "type", "email");
    			attr(input2, "class", "validate svelte-1t7hf0m");
    			attr(label2, "for", "email");
    			attr(label2, "class", "svelte-1t7hf0m");
    			attr(div5, "class", "input-field col s12 svelte-1t7hf0m");
    			attr(div6, "class", "row");
    			attr(input3, "id", "telephone");
    			attr(input3, "type", "tel");
    			attr(input3, "class", "validate svelte-1t7hf0m");
    			attr(label3, "for", "telephone");
    			attr(label3, "class", "svelte-1t7hf0m");
    			attr(div7, "class", "input-field col s12 svelte-1t7hf0m");
    			attr(div8, "class", "row");
    			attr(textarea, "maxlength", "1850");
    			textarea.required = true;
    			attr(textarea, "name", "message");
    			attr(textarea, "id", "message");
    			attr(textarea, "class", "materialize-textarea svelte-1t7hf0m");
    			attr(label4, "for", "message");
    			attr(label4, "class", "svelte-1t7hf0m");
    			attr(div9, "class", "input-field col s12 svelte-1t7hf0m");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("clas" in $$props) $$invalidate(5, clas = $$props.clas);
    	};

    	return [icon, to, alt, title, size, clas];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "social svelte-15lse65");
    			attr(div1, "class", "container");
    			attr(footer, "class", "page-footer svelte-15lse65");
    		},
    		m(target, anchor) {
    ...
    /* src/sections/Compromiso.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0.innerHTML = `<h4 class="center lighter">Compromiso social y ambiental</h4> 
        <p class="center svelte-1018dw0">En Kodefi apoyamos las iniciativas medioambientales y promovemos el desarrollo de nuevos emprendimientos.</p> 
        <p class="center svelte-1018dw0">Ponte en <a href="#contacto">contacto</a> con nosotros y aplica ahora.</p>`;
    			...
    			t9 = space();
    			div3 = element("div");
    			div3.innerHTML = `<p class="center disc svelte-1018dw0">* El equipo de Kodefi se reserva el derecho a elegir los proyectos a apoyar</p>`;
    			t11 = space();
    			div5 = element("div");
    			div4 = element("div");
    			create_component(buttonprimary.$$.fragment);
    			attr(div0, "class", "row");
    			attr(div1, "class", "col s10 m6 fhd4 offset-s1 offset-fhd2 svelte-1018dw0");
    			attr(div2, "class", "col s10 m6 fhd4 offset-s1 svelte-1018dw0");
    			attr(div3, "class", "row");
    			attr(div4, "class", "col s12 m10 offset-m1 l8 offset-l2");
    			attr(div5, "class", "row");
    			attr(div6, "class", "row");
    		},
    		m(target, anchor) {
    			...
    			append(div6, div5);
    			append(div5, div4);
    			mount_component(buttonprimary, div4, null);
    			current = true;
    		},
    		p: noop,
    		i(local) {
    ...
    class Compromiso extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			div6 = element("div");
    			div5 = element("div");
    			create_component(compromiso.$$.fragment);
    			t13 = space();
    			div7 = element("div");
    			create_component(contacto.$$.fragment);
    			t14 = space();
    			create_component(footer.$$.fragment);
    			attr(h3, "class", "svelte-15j6yma");
    			attr(h5, "class", "svelte-15j6yma");
    			attr(div0, "class", "header_content svelte-15j6yma");
    			attr(div1, "class", "container header_container svelte-15j6yma");
    			attr(header, "class", "svelte-15j6yma");
    			attr(div2, "class", "container somos-padding svelte-15j6yma");
    			attr(div3, "class", "container-fluid");
    			attr(div3, "id", "como_lo_hacemos");
    			attr(div4, "class", "container svelte-15j6yma");
    			attr(div4, "id", "servicios");
    			attr(div5, "class", "container");
    			attr(div6, "class", "container-fluid svelte-15j6yma");
    			attr(div6, "id", "compromiso");
    			attr(div7, "class", "container svelte-15j6yma");
    			attr(div7, "id", "contacto");
    			attr(main, "class", "svelte-15j6yma");
    		},
    		m(target, anchor) {
    			...
    			append(main, div6);
    			append(div6, div5);
    			mount_component(compromiso, div5, null);
    			append(main, t13);
    			append(main, div7);
    			mount_component(contacto, div7, null);
    			append(main, t14);
    		...
    		i(local) {
    			...
    			transition_in(compromiso.$$.fragment, local);
    		...
    		o(local) {
    			...
    			transition_out(compromiso.$$.fragment, local);
