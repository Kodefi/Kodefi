...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
        ...
        <p class="center svelte-yrat0c">En Kodefi apoyamos las iniciativas medioambientales y promovemos el desarrollo de nuevos emprendimientos.</p> 
        <p class="center svelte-yrat0c">Ponte en <a href="#contacto">contacto</a> con nosotros y aplica ahora.</p>`;
    			...
    			t9 = space();
    			div4 = element("div");
    			div4.innerHTML = `<p class="center disclaim svelte-yrat0c">* El equipo de Kodefi se reserva el derecho a elegir los proyectos a apoyar</p>`;
    			t11 = space();
    			div6 = element("div");
    			div5 = element("div");
    			create_component(buttonprimary.$$.fragment);
    			attr(div0, "class", "row");
    			attr(div1, "class", "col s10 m6 fhd4 offset-s1 offset-fhd2 svelte-yrat0c");
    			attr(div2, "class", "col s10 m6 fhd4 offset-s1 svelte-yrat0c");
    			attr(div3, "class", "row");
    			attr(div4, "class", "row");
    			attr(div5, "class", "col s12 m10 offset-m1 l8 offset-l2");
    			attr(div6, "class", "row");
    			attr(div7, "class", "row");
    		},
    		m(target, anchor) {
    			...
    			append(div7, div6);
    			append(div6, div5);
    			mount_component(buttonprimary, div5, null);
    			current = true;
    		},
    		p: noop,
    		i(local) {
