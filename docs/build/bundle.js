...
var app = (function () {
    ...
    class ButtonPrimary extends SvelteComponent {
    	constructor(options) {
    		...
    		init(this, options, instance$2, create_fragment$9, safe_not_equal, {
    			waves: 0,
    			size: 1,
    			icon: 2,
    			icon_position: 3,
    ...
    /* src/components/ComoLoHacemos.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$8(ctx) {
    	...
    	return {
    		c() {
    			...
    			div16.innerHTML = `<div class="col s12 m6 l4 offset-l1 svelte-14hecio"><div class="card svelte-14hecio"><div class="card-image"><img src="resources/consulting.svg" alt="" class="svelte-14hecio"/></div> 
            <div class="card-content center-align svelte-14hecio"><span class="card-title svelte-14hecio">Escuchamos tus necesidades</span> 
                <p>Cuentanos acerca de tu proyecto y contestamos tus dudas</p></div></div></div> 
    <div class="col s12 m6 l4 svelte-14hecio"><div class="card svelte-14hecio"><div class="card-image"><img src="resources/presentation.svg" alt="" class="svelte-14hecio"/></div> 
            <div class="card-content center-align svelte-14hecio"><span class="card-title svelte-14hecio">Realizamos una propuesta</span> 
                <p>planteamos la mejor solución para tu proyecto</p></div></div></div> 
    <div class="col s12 m6 l4 offset-l1 svelte-14hecio"><div class="card svelte-14hecio"><div class="card-image"><img src="resources/meeting.svg" alt="" class="svelte-14hecio"/></div> 
            <div class="card-content center-align svelte-14hecio"><span class="card-title  svelte-14hecio">Analizamos en conjunto</span> 
                <p>Definimos juntos una estrategia y creamos el producto ideal.</p></div></div></div> 
    <div class="col s12 m6 l4 svelte-14hecio"><div class="card svelte-14hecio"><div class="card-image"><img src="resources/launch.svg" alt="" class="svelte-14hecio"/></div> 
            <div class="card-content center-align svelte-14hecio"><span class="card-title svelte-14hecio">Desarrollamos y entregamos la solución</span> 
                <p>Desarrollamos tu producto<wbr/> y coordinamos la publicación del producto y seguimos de cerca el resultado.</p></div></div></div>`;

    			attr(div16, "class", "row svelte-14hecio");
    		},
    		m(target, anchor) {
    ...
    class Kodefi extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$1, create_fragment$7, safe_not_equal, { type: 2, style: 0 });
    	}
    }
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			t4 = space();
    			li2 = element("li");
    			li2.innerHTML = `<a href="/" class="svelte-1fv27n5">Open Source</a>`;
    			t6 = space();
    			li3 = element("li");
    			li3.innerHTML = `<a href="/" class="svelte-1fv27n5">Equipo</a>`;
    			t8 = space();
    			li4 = element("li");
    			...
    			attr(li2, "class", "hide-on-med-and-down desactivado svelte-1fv27n5");
    			attr(li3, "class", "hide-on-med-and-down desactivado svelte-1fv27n5");
    ...
    class WebDevelopment extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment$5, safe_not_equal, { style: 0 });
    	}
    }

    /* src/components/Somos.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			div.innerHTML = `<h5 class="lighter">Somos Kodefi,</h5> 
    <p class="svelte-1trpr4v">un equipo joven de programadores y desarrolladores,<wbr/> nos especializamos en el diseño y desarrollo de aplicaciones web.<br/></p> 
    <p class="svelte-1trpr4v">Utilizamos la última tecnología disponible para ofrecerte un producto moderno y durable en tiempo,<wbr/> nuestro constante aprendizaje garantiza nuestros resultados sigan las últimas tendencias en diseño y desarrollo.</p> 
    <p class="svelte-1trpr4v">Somos el punto de entrada a la digitalización de tu marca y de tu equipo.</p>`;

    			attr(div, "class", "svelte-1trpr4v");
    		},
    		m(target, anchor) {
    ...
    /* src/components/Servicios.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			div2.innerHTML = `<div class="col s12 m12 l6 frontend svelte-1j7bpep"><h4 class="lighter">Diseño y Desarrollo Web</h4> 
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, reprehenderit cumque nisi minima molestiae libero unde repellat atque, accusamus totam recusandae eum! Cum eligendi a quos quis corrupti minima sint?</p></div> 
    <div class="col s12 m12 l6 backend svelte-1j7bpep"><h4 class="lighter">Web Sevices</h4> 
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, reprehenderit cumque nisi minima molestiae libero unde repellat atque, accusamus totam recusandae eum! Cum eligendi a quos quis corrupti minima sint?</p></div>`;

    			t7 = space();
    			div5 = element("div");

    			div5.innerHTML = `<div class="col s12 m12 l6 review svelte-1j7bpep"><h4 class="lighter">Code Review</h4> 
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, reprehenderit cumque nisi minima molestiae libero unde repellat atque, accusamus totam recusandae eum! Cum eligendi a quos quis corrupti minima sint?</p></div> 
    <div class="col s12 m12 l6 consulting svelte-1j7bpep"><h4 class="lighter">Mentoría y Consultoría</h4> 
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, reprehenderit cumque nisi minima molestiae libero unde repellat atque, accusamus totam recusandae eum! Cum eligendi a quos quis corrupti minima sint?</p></div>`;

    			attr(div2, "class", "row svelte-1j7bpep");
    			attr(div5, "class", "row svelte-1j7bpep");
    		},
    		m(target, anchor) {
    ...
    /* src/components/Contacto.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			div12.innerHTML = `<form class="col s12"><div class="row"><div class="input-field col s6"><input placeholder="Placeholder" id="first_name" type="text" class="validate"/> 
          <label for="first_name">First Name</label></div> 
        <div class="input-field col s6"><input id="last_name" type="text" class="validate"/> 
          <label for="last_name">Last Name</label></div></div> 
      <div class="row"><div class="input-field col s12"><input disabled="" value="I am not editable" id="disabled" type="text" class="validate"/> 
          <label for="disabled">Disabled</label></div></div> 
      <div class="row"><div class="input-field col s12"><input id="password" type="password" class="validate"/> 
          <label for="password">Password</label></div></div> 
      <div class="row"><div class="input-field col s12"><input id="email" type="email" class="validate"/> 
          <label for="email">Email</label></div></div> 
      <div class="row"><div class="col s12">This is an inline input field:
          <div class="input-field inline"><input id="email_inline" type="email" class="validate"/> 
            <label for="email_inline">Email</label> 
            <span class="helper-text" data-error="wrong" data-success="right">Helper text</span></div></div></div></form>`;
    ...
    function create_fragment$1(ctx) {
    	...
    	let t2;
    	let current;
    	kodefi = new Kodefi({ props: { type: "lighter" } });

    	return {
    		c() {
    			footer = element("footer");
    			div0 = element("div");
    			div0.innerHTML = `<p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iusto, quae voluptatibus doloremque pariatur a, impedit molestiae quasi deleniti ea tempore omnis illum, tenetur vitae quia! Aperiam repudiandae dolorem laborum sint!</p>`;
    			t1 = space();
    			div2 = element("div");
    			div1 = element("div");
    			create_component(kodefi.$$.fragment);
    			...
    			attr(div2, "class", "footer-copyright");
    			attr(footer, "class", "page-footer svelte-1rm06nf");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h3, "class", "svelte-1iwhaur");
    			attr(h5, "class", "svelte-1iwhaur");
    			attr(div0, "class", "header_content svelte-1iwhaur");
    			attr(div1, "class", "container header_container svelte-1iwhaur");
    			attr(header, "class", "svelte-1iwhaur");
    			attr(div2, "class", "container somos-padding svelte-1iwhaur");
    			attr(div3, "class", "container");
    			attr(div4, "class", "container-fluid");
    			attr(div4, "id", "servicios");
    			attr(div5, "class", "container");
    			attr(main, "class", "svelte-1iwhaur");
    		},
    		m(target, anchor) {
