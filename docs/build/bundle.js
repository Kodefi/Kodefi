...
var app = (function () {
    ...
    class Kodefi extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$8, safe_not_equal, { type: 2, style: 0 });
    	}
    }
    ...
    class WebDevelopment extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$1, create_fragment$6, safe_not_equal, { style: 0 });
    	}
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			div10.innerHTML = `<form class="col s12 l8 offset-l2"><div class="row"><div class="input-field col s12"><input required="" id="name" type="text" class="validate"/> 
          <label for="name">Nombre</label></div></div> 

      <div class="row"><div class="input-field col s12"><input required="" id="email" type="email" class="validate"/> 
          <label for="email">Email</label></div></div> 

      <div class="row"><div class="input-field col s12"><input id="telephone" type="text" class="validate"/> 
          <label for="telephone">Teléfono</label></div></div> 

      <div class="row"><div class="input-field col s12"><textarea required="" name="message" id="message" class="materialize-textarea"></textarea> 
          <label for="message">Mensaje</label></div></div> 

      <div class="row"><input style="color: #fff7f2; background-color: #669fa4" type="submit" value="Enviar" class="col s6 btn offset-s3"/></div></form>`;
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			set_style(div, "--icon-size", /*size*/ ctx[3]);
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			append(div, a);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [icon, to, alt, size];
    }

    class Icon extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment$2, safe_not_equal, { icon: 0, to: 1, alt: 2, size: 3 });
    	}
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "social svelte-an0zi9");
    			attr(div1, "class", "container");
    			attr(footer, "class", "page-footer svelte-an0zi9");
    		},
    		m(target, anchor) {
